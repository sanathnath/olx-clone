    ...
    return (
        <div className='product-parent'>
            ...
            <div className="left-category">
                <div className="left-cat-head"
                onClick={()=>{
                    setIsSubCat(!IsSubCat)
                }}>
                <h5><strong>CATEGORIES</strong></h5>
                <svg width="18px" height="18px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd"><path class="rui-4K4Y7" d="M85.392 746.667h60.331l366.336-366.336 366.336 366.336h60.331v-60.331l-408.981-409.003h-35.307l-409.045 409.003z"></path></svg>
                </div>
                <div style={{borderBottom:"1px solid rgba(0, 0, 0, 0.4)", paddingBottom:"25px"}}>
                    {!IsSubCat &&
                    <span>{ Catgry }</span> }
                { IsSubCat &&     <div>
               ...
               <div className='sub-cat'>
                <div className="left-main-cat">
                    ...
                    <span><strong>{ Catgry }</strong></span>
                </div>
                <ul>
                    <li>Mobile Phones</li>
                    <li>Tablets</li>
